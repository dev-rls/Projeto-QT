...
import sys
from Login import Ui_Login  # Certifique-se de que o nome do arquivo e da classe estejam corretos
from Registro import Ui_tela_principal_registro  # Certifique-se de que o nome do arquivo e da classe estejam corretos
from Inicio import Ui_Inicio  # Certifique-se de que o nome do arquivo e da classe estejam corretos
from Home import Ui_Home  # Certifique-se de que o nome do arquivo e da classe estejam corretos
...
class LoginDialog(QDialog):
    ...
    def check_login(self):
        ...
        # Exemplo de verificação de credenciais (você pode substituir por sua lógica de verificação)
