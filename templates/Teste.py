...
#     inicio = Ui_Inicio(stacked_widget)
#     login = Login (stacked_widget)
#     register = Ui_tela_principal_registro()
#     home = Ui_Home()
...
# from PySide6.QtWidgets import QApplication, QDialog, QMainWindow, QStackedWidget, QMessageBox
# import sys
# from modulos.main import Ui_Login  # Certifique-se de que o nome do arquivo e da classe estejam corretos
